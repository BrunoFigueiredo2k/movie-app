...
type
GetPropertyValue = (HTMLElementWithStyleMap
|
CSSStyleRule | CSSKeyframeRule, string
) =>
string
...
type
RemoveProperty = (HTMLElementWithStyleMap
|
CSSStyleRule | CSSKeyframeRule, string
) =>
void
...
type
SetSelector = (CSSStyleRule, string) => boolean
...
insertRules(rules
:
RuleList, nativeParent ? : CSSStyleSheet | CSSMediaRule | CSSKeyframesRule
)
{
