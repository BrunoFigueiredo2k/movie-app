...
++) {
    ...
    rule
.
    style = this.registry.onProcessStyle[i](rule.style, rule, sheet)
}
}
...
void {
    for(let i = 0; i < this.registry.onProcessSheet.length;
i++
)
{
...
Object, rule
:
Rule, sheet ? : StyleSheet, options
:
UpdateOptions
):
void {
    for(let i = 0; i < this.registry.onUpdate.length;
i++
)
{
