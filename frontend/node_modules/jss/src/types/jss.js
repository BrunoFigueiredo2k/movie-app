...
:
    ...
    setProperty(
        cssRule
:
    HTMLElementWithStyleMap | CSSStyleRule,
        prop
:
    string,
        value
...
:
    HTMLElementWithStyleMap | CSSStyleRule, prop
:
    string
):
    string;
    removeProperty(cssRule
:
    HTMLElementWithStyleMap | CSSStyleRule, prop
:
    string
...
export
type
OnProcessRule = (rule: Rule, sheet
? : StyleSheet
) =>
void
export
type
OnProcessStyle = (style: JssStyle, rule: Rule, sheet
? : StyleSheet
) =>
JssStyle
export
...
export
type
InsertionPoint = string | HTMLElementWithStyleMap
